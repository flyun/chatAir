...
<p align="left">
  ...
  <div align="left">ChatAir 是 ChatGPT、Gemini、Claude 和 DeepSeek 的原生Android应用程序</div>
</p>


## Android 版 ChatAir

ChatAir 是 ChatGPT、Gemini、Claude 和 DeepSeek 的原生Android应用程序，提供更流畅、更快速的聊天体验。
...
- 🔬 **高级**: 支持 OpenAI/Gemini/Claude/DeepSeek 的 API 调用，以及 OpenRouter/One-api/Ollama 等自定义服务器地址替换，灵活定制你的服务器地址
...
- 🌏 **多语**: 支持英语、简体中文、繁体中文、法语、意大利语、西班牙语、德语、荷兰语、阿拉伯语、葡萄牙语、日语、韩语、俄语、越南语、印尼语
