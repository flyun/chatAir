 ...
 */
class ChangeDeepseekApiKeyActivity extends BaseFragment {
   ...
   public ChangeDeepseekApiKeyActivity(Theme.ResourcesProvider resourcesProvider) {
   ...
   public View createView(Context context) {
      ...
      actionBar.setTitle(LocaleController.getString("ChangeDeepseekApiKey", R.string.ChangeDeepseekApiKey));
         ...
         public void onItemClick(int id) {
            if (id == -1) {
               ...
               Browser.openUrl(getParentActivity(),
                       LocaleController.getString("FindDeepseekKeyUrl", R.string.FindDeepseekKeyUrl));
            }
         }
      });
      ...
      firstNameField.setHint(LocaleController.formatApiKey(UserConfig.getInstance(currentAccount).apiKeyDeepseek));
   ...
   private void saveApiKey() {
      ...
      String apiKey = UserConfig.getInstance(currentAccount).apiKeyDeepseek;
      ...
      if (newFirst.length() == 0) {
         ...
         AlertDialog alertDialog = AlertsCreator.createSimpleAlert(getContext(),
                 LocaleController.getString("ChangeDeepseekApiKey", R.string.ChangeDeepseekApiKey),
   ...
   private void changeApiKey(String newFirst) {
      ...
      UserConfig.getInstance(currentAccount).apiKeyDeepseek = newFirst;
      UserConfig.getInstance(currentAccount).saveConfig(false);

      NotificationCenter.getInstance(currentAccount)
              .postNotificationName(NotificationCenter.updateDeepseekApiKey);
   ...
   private void verifyKey() {
      ...
      if (firstNameField.getText() == null) {
         ...
         newFirst = UserConfig.getInstance(currentAccount).apiKeyDeepseek;
      }

      if (TextUtils.isEmpty(newFirst) || checkValue(newFirst)) return;

      openAiService.changeLLMToken(newFirst, LLMType.deepseek);
              ...
              new OpenAiService.ResultCallBack() {
                 ...
                 public void onSuccess(ChatCompletionResult result) {
                    AndroidUtilities.runOnUIThread(() -> {
                       ...
                       AlertsCreator.showSimpleAlert(ChangeDeepseekApiKeyActivity.this,
                 ...
                 public void onError(OpenAiHttpException error, Throwable throwable) {
                    AndroidUtilities.runOnUIThread(() -> {
                       ...
                       AlertsCreator.processError(errorTx, ChangeDeepseekApiKeyActivity.this);
                    });
                 }
