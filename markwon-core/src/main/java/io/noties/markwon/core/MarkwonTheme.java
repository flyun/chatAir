...
public class MarkwonTheme {
    ...
    public static Builder builderWithDefaults(@NonNull Context context) {
        ...
        return new Builder()
                .codeBlockMargin(dip.toPx(8))//代码块边缘距离代码间隔
    ...
    protected static final int CODE_DEF_BACKGROUND_BLOCK_COLOR_ALPHA = 10;
    protected static final float CODE_DEF_TEXT_SIZE_RATIO = .77F;//代码块中代码字体大小
    ...
    protected final int codeBlockBackgroundDarkColor;
    ...
    protected MarkwonTheme(@NonNull Builder builder) {
        ...
        this.codeBlockBackgroundDarkColor = builder.codeBlockBackgroundDarkColor;
    ...
    public int getCodeBlockBackgroundColor(@NonNull Paint paint) {
        ...
        return color != 0
                ? color
                : ColorUtils.applyAlpha(paint.getColor(), CODE_DEF_BACKGROUND_BLOCK_COLOR_ALPHA);
    }

    public int getCodeBlockBackgroundDarkColor(@NonNull Paint paint) {

        final int color = codeBlockBackgroundDarkColor != 0
    ...
    public static class Builder {
        ...
        private int codeBlockBackgroundDarkColor;
        ...
        Builder(@NonNull MarkwonTheme theme) {
            ...
            this.codeBlockBackgroundDarkColor = theme.codeBlockBackgroundDarkColor;
        ...
        @NonNull
        public Builder codeBlockBackgroundDarkColor(@ColorInt int codeBlockBackgroundDarkColor) {
            this.codeBlockBackgroundDarkColor = codeBlockBackgroundDarkColor;
            return this;
        }
